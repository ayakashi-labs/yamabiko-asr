...
const USAGE: &str = "usage: audio_file [--device auto|cpu|directml|cuda|tensorrt|openvino|qnn|vitis|nvrtx|webgpu|tvm|xnnpack|onednn] [--vad-threshold VALUE] [--vad-min-speech-ms MS] [--vad-min-silence-ms MS] [--vad-speech-pad-ms MS] <model-dir> <16k-mono-wav>";
